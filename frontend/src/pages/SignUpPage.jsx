                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    <input type="text"
                      ...
                      onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} className='input' placeholder='John Doe'
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    <input type="email"
                      ...
                      onChange={(e) => setFormData({ ...formData, email: e.target.value })} className='input' placeholder='johndoe@gmail.com'
                    />
                  </div>
                </div>
                {/* PASSWORD INPUT */}
